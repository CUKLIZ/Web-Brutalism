<footer style="margin-top: 100px; border-top: 8px solid black; background: #fff; padding: 60px 0;">
    <div class="container text-center">
        ...
        <div class="flex" style="justify-content: center; gap: 20px; margin-top: 20px;">
            ...
            <a href="#" class="brutal-button" style="padding: 10px 30px; background: var(--accent-pink); color: white;">TWIT</a>
            <a href="#" class="brutal-button" style="padding: 10px 30px; background: var(--neon-green);">VOID</a>
        </div>
        <p class="brutal-font" style="margin-top: 40px; font-size: 0.7rem; color: #888;">[ENCRYPTED_CONNECTION_ACTIVE]</p>
    </div>
</footer>
