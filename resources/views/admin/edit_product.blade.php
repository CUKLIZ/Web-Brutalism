        ...
        <div class="admin-stat-card">
            ...
            <div style="display: grid; gap: 20px;">
                ...
                <div>
                    ...
                    <div style="display: flex; gap: 10px; align-items: center; border: 3px solid black; padding: 12px; background: {{ old('is_featured', $product->is_featured) ? 'var(--neon-green)' : 'white' }};" id="featured-box">
