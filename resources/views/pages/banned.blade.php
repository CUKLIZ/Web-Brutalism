...
<div class="banned-container">
    ...
    <div class="banned-card">
        ...
        <div class="terminal-block">
            ...
            <div>> IDENTITY_UUID: {{ strtoupper(str_pad($user->id, 8, '0', STR_PAD_LEFT)) }}-X9-NULL</div>
            <div>> USERNAME: {{ strtoupper($user->username) }}</div>
        ...
        <div class="banned-actions">
            <a href="mailto:support@voidstreet.com" class="btn-banned btn-red">CONTACT_SUPPORT</a>
            <a href="/" class="btn-banned">RETURN_HOME</a>
            <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                @csrf
                <button type="submit" class="btn-banned" style="opacity: 0.6; border-width: 2px; font-size: 0.8rem;">LOGOUT</button>
            </form>
        </div>
    </div>
