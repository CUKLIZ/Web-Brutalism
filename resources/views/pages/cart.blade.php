...
@section('content')
    <section class="container" style="padding: 60px 0; background: #D9D9D9; min-height: 100vh;">
        <div style="margin-bottom: 60px;">
            <h1 style="font-size: 8rem; line-height: 0.8; font-style: italic; font-weight: 900; letter-spacing: -4px;">
                YOUR_LOOT</h1>
            <p class="brutal-font"
                style="font-size: 2rem; border-bottom: 6px solid black; display: inline-block; padding-bottom: 10px;"
                id="item-count">[0{{ $cartItems->count() }}_ITEMS_IN_STORAGE]</p>
        </div>
            ...
            <div class="cart-grid">
                ...
                <div class="summary-panel"
                    ...
                    <button class="brutal-button"
                        style="width: 100%; text-align: center; background: black; color: white; font-size: 1.1rem; padding: 12px 0; margin-bottom: 30px; border: 4px solid black; font-weight: 900; text-transform: uppercase;">
                        APPLY_DISCOUNT_CODE
                    </button>
